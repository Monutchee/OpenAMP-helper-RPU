#ifndef MNC_OPENAMP_PLATFORM_HPP
#define MNC_OPENAMP_PLATFORM_HPP

/*
 * Thin RAII wrapper around the AMD OpenAMP/remoteproc platform glue
 * (machine/zynqmp_r5/platform_info.c). It owns the lifecycle of the remoteproc
...
#endif /* MNC_OPENAMP_PLATFORM_HPP */
